...
<div class="container post-container">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade post-images flex-column"
        data-bs-ride="carousel">
        <div class="carousel-item active">
            <img width="510" height="510" src="{{ Storage::disk('public')->url($post->images[0]->img_path) }}"
                class="d-block w-100">
        </div>
    ...
    <div class="comments-container flex-column align-items-end" style="max-height: 400px; overflow-y: auto;">
        <div class="post-header">
            @if (! $post->user->avatar)
                <img src="{{ asset('img/default_user_img.png') }}" alt="User Image">
            @else
        ...
        <div id="commentContainer">
            ...
            <div class="comment">
                <div class="d-flex mb-3">
                    <img src="{{ Storage::disk('public')->url($comment->user->avatar) }}" alt=""
